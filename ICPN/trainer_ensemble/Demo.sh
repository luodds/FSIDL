...
# Evaluate 
python test_fsl.py   --shot 5 --eval_shot 5 --num_test_episodes 100   --test_model /home/liuziyi/cub/trainer_ensemble/checkpoints/subsets/MiniImageNet-ProtoNet-Res12-05w05s15q-Pre-DIS/Distill:PN_Coo_10_lr1e-05_T120.0T232_5w_5s-FBN --gpu 0
