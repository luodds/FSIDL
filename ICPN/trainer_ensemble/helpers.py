...
import sys
sys.path.append(r'home/liuziyi/cub/dataloader')
...
def get_dataloader(args):
    ...
    t_subset_a = Dataset(args.subset_A, args, augment=args.augment)#������dataloader.mini_imagenet.MiniImageNet  
    #print("t_subset_a:",t_subset_a)
    args.num_class_a = t_subset_a.num_class
    #print("args.num_class_a:",args.num_class_a)
    train_sampler_a = CategoriesSampler(t_subset_a.label, num_episodes, max(args.way, args.num_classes), args.shot + args.query)
    #print(train_sampler_a)
